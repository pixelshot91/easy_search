...
class BuildItemResult {
  ...
  const BuildItemResult({
    ...
    double? removeItemIconBackgroundOpacity,
        ...
        this.circularBackgroundBorderRadius =
            circularBackgroundBorderRadius != null
                ? circularBackgroundBorderRadius
                : 17.0,
        this.backgroundPadding = backgroundPadding != null
            ? backgroundPadding
        ...
        this.circularBorderRadiusItem =
            circularBorderRadiusItem != null ? circularBorderRadiusItem : 17.0,
        this.itemPadding = itemPadding != null
            ? itemPadding
            : const EdgeInsets.only(
                left: 8.0, top: 8.0, right: 8.0, bottom: 8.0),
        this.spacingBetweenItem =
            spacingBetweenItem != null ? spacingBetweenItem : 5.0,
        this.itemValue =
            itemValue != null ? itemValue : const LabelSettings.searchItem(),
        this.removeItemIcon =
            removeItemIcon != null ? removeItemIcon : Icons.close,
        this.removeItemIconColor =
            removeItemIconColor != null ? removeItemIconColor : Colors.red,
        this.removeItemIconOpacity = removeItemIconOpacity != null &&
                removeItemIconOpacity >= 0.0 &&
                removeItemIconOpacity <= 1.0
            ? removeItemIconOpacity
            : 0.8,
        this.removeItemIconBackgroundColor =
            removeItemIconBackgroundColor != null
                ? removeItemIconBackgroundColor
                : Colors.white,
        this.removeItemIconBackgroundOpacity =
            removeItemIconBackgroundOpacity != null &&
